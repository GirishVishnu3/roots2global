      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          <div className="flex flex-col items-center text-center">
            <div className="bg-green-100 size-12 rounded-full flex items-center justify-center mb-2">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="bg-blue-100 size-12 rounded-full flex items-center justify-center mb-2">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="bg-purple-100 size-12 rounded-full flex items-center justify-center mb-2">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="bg-orange-100 size-12 rounded-full flex items-center justify-center mb-2">
              <RotateCcw className="size-6 text-orange-600" />
            </div>
            <p className="text-sm font-semibold text-gray-900">7-Day Replacement</p>
            <p className="text-xs text-gray-600">Easy Exchange</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <div className="bg-red-100 size-12 rounded-full flex items-center justify-center mb-2">
